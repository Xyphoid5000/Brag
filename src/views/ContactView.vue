  ...
  <div class="landing-page contact-page">
    ...
    <main class="contact-page__main">
      ...
      <div class="contact-page__heading">
        ...
        <p>Tell us what happened and we'll help you figure out the next step. Prefer to talk? <a href="tel:2165550194">(216) 555-0194</a></p>
      </div>
      <form class="contact-form" @submit.prevent="submitContactForm">
        <div class="contact-form__row"><label><span>Name</span><input name="name" type="text" autocomplete="name" required placeholder="Your name" /></label><label><span>Phone</span><input name="phone" type="tel" autocomplete="tel" placeholder="(216) 555-0194" /></label></div>
